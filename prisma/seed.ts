...
async function main() {
  ...
  // Build lookup: Dynacare profile code → componentCodes from seed1.ts
  ...
  console.log(`  ${bundleCount} bundle deals seeded (${cdlProfiles.length} CDL + ${qcProfiles.length} Dynacare)`);
