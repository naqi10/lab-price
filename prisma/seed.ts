...
async function main() {
  ...
  const labCentralTests = [
    // Biochimie
    { name: "Glycémie à jeun", code: "BIO-001", price: 30, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Hémoglobine glyquée (HbA1c)", code: "BIO-002", price: 120, unit: "%", category: "Biochimie", turnaroundTime: "Résultats en 24 heures" },
    { name: "Cholestérol total", code: "BIO-003", price: 40, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "HDL-Cholestérol", code: "BIO-004", price: 50, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "LDL-Cholestérol", code: "BIO-005", price: 50, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Triglycérides", code: "BIO-006", price: 40, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Créatinine sérique", code: "BIO-007", price: 35, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Urée sanguine", code: "BIO-008", price: 30, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Acide urique", code: "BIO-009", price: 35, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    { name: "Transaminases ASAT (TGO)", code: "BIO-010", price: 40, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Transaminases ALAT (TGP)", code: "BIO-011", price: 40, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Gamma GT", code: "BIO-012", price: 40, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Bilirubine totale", code: "BIO-013", price: 35, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    { name: "Protéines totales", code: "BIO-014", price: 30, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    { name: "CRP (Protéine C-réactive)", code: "BIO-015", price: 60, unit: "mg/L", category: "Biochimie", turnaroundTime: "Même jour" },
    // Hématologie
    { name: "NFS (Numération Formule Sanguine)", code: "HEM-001", price: 60, unit: "", category: "Hématologie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Vitesse de sédimentation (VS)", code: "HEM-002", price: 25, unit: "mm", category: "Hématologie", turnaroundTime: "Même jour" },
    { name: "TP / INR", code: "HEM-003", price: 50, unit: "%", category: "Hématologie", turnaroundTime: "Résultats en 3 heures" },
    { name: "TCA", code: "HEM-004", price: 50, unit: "sec", category: "Hématologie", turnaroundTime: "Résultats en 3 heures" },
    { name: "Fibrinogène", code: "HEM-005", price: 50, unit: "g/L", category: "Hématologie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Groupage sanguin ABO-Rh", code: "HEM-006", price: 45, unit: "", category: "Hématologie", turnaroundTime: "Résultats en 24 heures" },
    // Hormonologie
    { name: "TSH (Thyréostimuline)", code: "HOR-001", price: 100, unit: "mUI/L", category: "Hormonologie", turnaroundTime: "Résultats en 24 heures" },
    { name: "T3 libre", code: "HOR-002", price: 90, unit: "pmol/L", category: "Hormonologie", turnaroundTime: "Résultats en 24 heures" },
    { name: "T4 libre", code: "HOR-003", price: 90, unit: "pmol/L", category: "Hormonologie", turnaroundTime: "Résultats en 24 heures" },
    { name: "PSA total", code: "HOR-004", price: 120, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "Résultats en 24–48 heures" },
    { name: "Vitamine D (25-OH)", code: "HOR-005", price: 200, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "3–5 jours ouvrables" },
    { name: "Ferritine", code: "HOR-006", price: 100, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "Résultats en 24 heures" },
    // Sérologie
    { name: "Sérologie Hépatite B (AgHBs)", code: "SER-001", price: 80, unit: "", category: "Sérologie", turnaroundTime: "Résultats en 24 heures" },
    { name: "Sérologie Hépatite C (Anti-HCV)", code: "SER-002", price: 100, unit: "", category: "Sérologie", turnaroundTime: "Résultats en 24 heures" },
    { name: "Sérologie HIV 1+2", code: "SER-003", price: 100, unit: "", category: "Sérologie", turnaroundTime: "Résultats en 24 heures" },
    { name: "Sérologie Toxoplasmose IgG/IgM", code: "SER-004", price: 120, unit: "", category: "Sérologie", turnaroundTime: "Résultats en 24–48 heures" },
    { name: "Sérologie Rubéole IgG/IgM", code: "SER-005", price: 120, unit: "", category: "Sérologie", turnaroundTime: "Résultats en 24–48 heures" },
    // Microbiologie
    { name: "ECBU (Examen cytobactériologique des urines)", code: "MIC-001", price: 80, unit: "", category: "Microbiologie", turnaroundTime: "Résultats en 24–48 heures" },
    { name: "Hémoculture", code: "MIC-002", price: 150, unit: "", category: "Microbiologie", turnaroundTime: "3–5 jours ouvrables" },
    { name: "Coproculture", code: "MIC-003", price: 120, unit: "", category: "Microbiologie", turnaroundTime: "3–5 jours ouvrables" },
  ];

  const bioLabTests = [
    // Biochimie — slightly different names, different prices
    { name: "Glucose sanguin à jeun", code: "GL-01", price: 28, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    { name: "HbA1c", code: "HBA-01", price: 110, unit: "%", category: "Biochimie", turnaroundTime: "1 jour ouvrable" },
    { name: "Cholestérol Total", code: "CHO-01", price: 38, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "HDL Cholestérol", code: "CHO-02", price: 45, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "LDL Cholestérol", code: "CHO-03", price: 45, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Triglycérides sériques", code: "TG-01", price: 38, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Créatinine", code: "CR-01", price: 32, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    { name: "Urée", code: "UR-01", price: 28, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    { name: "Acide Urique sérique", code: "AU-01", price: 32, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "ASAT / GOT", code: "TRA-01", price: 38, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "ALAT / GPT", code: "TRA-02", price: 38, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Gamma-Glutamyl Transférase", code: "GGT-01", price: 42, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Bilirubine Totale", code: "BIL-01", price: 32, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Protéines Totales sériques", code: "PT-01", price: 28, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "CRP ultra-sensible", code: "CRP-01", price: 55, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 2 heures" },
    // Hématologie
    { name: "Hémogramme complet (NFS)", code: "NFS-01", price: 55, unit: "", category: "Hématologie", turnaroundTime: "Résultats en 3 heures" },
    { name: "VS (Vitesse de sédimentation)", code: "VS-01", price: 22, unit: "mm", category: "Hématologie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Taux de Prothrombine (TP)", code: "TP-01", price: 48, unit: "%", category: "Hématologie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Temps de Céphaline Activée", code: "TCA-01", price: 48, unit: "sec", category: "Hématologie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Fibrinogène plasmatique", code: "FIB-01", price: 48, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Groupage ABO Rhésus", code: "GR-01", price: 42, unit: "", category: "Hématologie", turnaroundTime: "1 jour ouvrable" },
    // Hormonologie
    { name: "TSH ultra-sensible", code: "TSH-01", price: 95, unit: "mUI/L", category: "Hormonologie", turnaroundTime: "1–2 jours ouvrables" },
    { name: "FT3 (T3 libre)", code: "FT3-01", price: 85, unit: "pmol/L", category: "Hormonologie", turnaroundTime: "1–2 jours ouvrables" },
    { name: "FT4 (T4 libre)", code: "FT4-01", price: 85, unit: "pmol/L", category: "Hormonologie", turnaroundTime: "1–2 jours ouvrables" },
    { name: "PSA Total", code: "PSA-01", price: 115, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "25-OH Vitamine D", code: "VD-01", price: 180, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "5–7 jours ouvrables" },
    { name: "Ferritine sérique", code: "FER-01", price: 95, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "1–2 jours ouvrables" },
    // Sérologie
    { name: "Ag HBs (Hépatite B)", code: "HB-01", price: 75, unit: "", category: "Sérologie", turnaroundTime: "1–2 jours ouvrables" },
    { name: "Anti-HCV (Hépatite C)", code: "HC-01", price: 95, unit: "", category: "Sérologie", turnaroundTime: "1–2 jours ouvrables" },
    { name: "HIV 1 et 2 (Sérologie)", code: "HIV-01", price: 95, unit: "", category: "Sérologie", turnaroundTime: "1–2 jours ouvrables" },
    { name: "Toxoplasmose IgG + IgM", code: "TOX-01", price: 110, unit: "", category: "Sérologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "Rubéole IgG + IgM", code: "RUB-01", price: 110, unit: "", category: "Sérologie", turnaroundTime: "2–3 jours ouvrables" },
    // Microbiologie
    { name: "Examen Cytobactériologique Urinaire", code: "ECB-01", price: 75, unit: "", category: "Microbiologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "Hémoculture (aéro + anaéro)", code: "HEM-01", price: 140, unit: "", category: "Microbiologie", turnaroundTime: "5–7 jours ouvrables" },
    { name: "Coproculture + Antibiogramme", code: "COP-01", price: 115, unit: "", category: "Microbiologie", turnaroundTime: "5–7 jours ouvrables" },
  ];

  const medAnalyseTests = [
    // Biochimie — yet another naming style, different prices
    { name: "Glycémie", code: "G001", price: 35, unit: "g/L", category: "Biochimie", turnaroundTime: "Même jour" },
    { name: "Hémoglobine Glyquée A1c", code: "G002", price: 130, unit: "%", category: "Biochimie", turnaroundTime: "2 jours ouvrables" },
    { name: "Dosage Cholestérol", code: "L001", price: 42, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 8 heures" },
    { name: "Dosage HDL", code: "L002", price: 55, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 8 heures" },
    { name: "Dosage LDL", code: "L003", price: 55, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 8 heures" },
    { name: "Dosage Triglycérides", code: "L004", price: 42, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 8 heures" },
    { name: "Créatininémie", code: "R001", price: 38, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Dosage Urée", code: "R002", price: 32, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 2 heures" },
    { name: "Uricémie", code: "R003", price: 38, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "TGO (ASAT)", code: "H001", price: 42, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "TGP (ALAT)", code: "H002", price: 42, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "GGT", code: "H003", price: 38, unit: "UI/L", category: "Biochimie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Bilirubine T", code: "H004", price: 38, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Protidémie", code: "P001", price: 32, unit: "g/L", category: "Biochimie", turnaroundTime: "Résultats en 4 heures" },
    { name: "CRP quantitative", code: "I001", price: 65, unit: "mg/L", category: "Biochimie", turnaroundTime: "Résultats en 3 heures" },
    // Hématologie
    { name: "Numération Formule Sanguine", code: "N001", price: 65, unit: "", category: "Hématologie", turnaroundTime: "Résultats en 4 heures" },
    { name: "Vitesse Sédimentation", code: "N002", price: 28, unit: "mm", category: "Hématologie", turnaroundTime: "Résultats en 2 heures" },
    { name: "TP-INR", code: "C001", price: 55, unit: "%", category: "Hématologie", turnaroundTime: "Résultats en 6 heures" },
    { name: "TCA (Temps Céphaline)", code: "C002", price: 55, unit: "sec", category: "Hématologie", turnaroundTime: "Résultats en 6 heures" },
    { name: "Dosage Fibrinogène", code: "C003", price: 55, unit: "g/L", category: "Hématologie", turnaroundTime: "Résultats en 8 heures" },
    { name: "Groupe Sanguin ABO-Rhésus", code: "N003", price: 48, unit: "", category: "Hématologie", turnaroundTime: "2 jours ouvrables" },
    // Hormonologie
    { name: "Dosage TSH", code: "T001", price: 105, unit: "mUI/L", category: "Hormonologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "T3 Libre", code: "T002", price: 95, unit: "pmol/L", category: "Hormonologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "T4 Libre", code: "T003", price: 95, unit: "pmol/L", category: "Hormonologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "Antigène Prostatique Spécifique", code: "M001", price: 125, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "3–5 jours ouvrables" },
    { name: "Vitamine D totale", code: "V001", price: 220, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "5–7 jours ouvrables" },
    { name: "Dosage Ferritine", code: "F001", price: 105, unit: "ng/mL", category: "Hormonologie", turnaroundTime: "2–3 jours ouvrables" },
    // Sérologie
    { name: "Antigène HBs", code: "S001", price: 85, unit: "", category: "Sérologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "Anticorps Anti-HCV", code: "S002", price: 105, unit: "", category: "Sérologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "Sérologie VIH 1+2", code: "S003", price: 105, unit: "", category: "Sérologie", turnaroundTime: "2–3 jours ouvrables" },
    { name: "Sérologie Toxoplasmose", code: "S004", price: 125, unit: "", category: "Sérologie", turnaroundTime: "3–5 jours ouvrables" },
    { name: "Sérologie Rubéole", code: "S005", price: 125, unit: "", category: "Sérologie", turnaroundTime: "3–5 jours ouvrables" },
    // Microbiologie
    { name: "ECBU", code: "B001", price: 85, unit: "", category: "Microbiologie", turnaroundTime: "3–5 jours ouvrables" },
    { name: "Hémoculture", code: "B002", price: 160, unit: "", category: "Microbiologie", turnaroundTime: "5–7 jours ouvrables" },
    { name: "Coproculture", code: "B003", price: 125, unit: "", category: "Microbiologie", turnaroundTime: "5–7 jours ouvrables" },
  ];

  // ── Price Lists & Tests ─────────────────────────────────────────────
  // Clean existing data (in order to avoid duplicate key errors on re-seed)
  // Must respect FK constraints: quotation items → test mappings, etc.
  await prisma.quotationEmail.deleteMany();
