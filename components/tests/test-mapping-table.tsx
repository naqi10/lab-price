...
export default function TestMappingTable({ mappings, onEdit, onDelete }: { mappings: any[]; onEdit: (m: any) => void; onDelete: (id: string) => void }) {
  return (
    <Table>
      <TableHeader><TableRow><TableHead>Nom canonique</TableHead><TableHead>Catégorie</TableHead><TableHead>Correspondances</TableHead><TableHead className="text-right">Actions</TableHead></TableRow></TableHeader>
      <TableBody>
